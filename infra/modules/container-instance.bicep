...
// Azure Container Instance module for containerized service deployment
...
@description('Optional. ACR login server URL for image pull.')
param acrLoginServer string = ''

@description('Optional. Managed identity resource ID for ACR image pull credentials.')
