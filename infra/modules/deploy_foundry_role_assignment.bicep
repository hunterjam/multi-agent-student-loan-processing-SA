// ========== deploy_foundry_role_assignment.bicep ========== //
// Module to assign RBAC roles to managed identity on an existing AI Services account
// Required when reusing an existing AI Foundry project from a different resource group
...
// Azure AI User role - for AI Foundry project access
resource azureAiUserRole 'Microsoft.Authorization/roleDefinitions@2022-04-01' existing = {
  name: '53ca6127-db72-4b80-b1b0-d745d6d5456d'
}

// Cognitive Services OpenAI User role - for chat completions
